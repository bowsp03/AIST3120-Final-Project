...
from torch.optim.lr_scheduler import StepLR  # Added StepLR import
...
def train(args, model, train_features, benchmarks):
    ...
    # Changed to StepLR scheduler with configurable parameters
    ...
    for epoch in range(int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(tqdm(train_dataloader)):
            ...
            if step % args.gradient_accumulation_steps == 0:
                ...
                wandb.log({'lr': optimizer.param_groups[0]['lr']}, step=num_steps)  # Log learning rate
...
def main():
    ...
    # Rest of the existing arguments remain the same
